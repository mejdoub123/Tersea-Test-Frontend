    ...
    <div class="page page-center">
      <div class="container-tight py-4">
        ...
        <form class="card card-md" action="." method="get">
          <div class="card-body">
            <h2 class="card-title text-center mb-4">Create Employee account</h2>
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <div class="input-group input-group-flat">
                <input
                  type="password"
                  v-model="employeePasswordConfirmation"
                  class="form-control"
...
const employeeCin = ref("");
const employeeAddress = ref("");
const employeePassword = ref("");
const employeePasswordConfirmation = ref("");
...
const registerUser = async () => {
  const user = {
    ...
    password_confirmation: employeePasswordConfirmation.value,
  };
  loading.value = true;
  await auth
    .register(user)
